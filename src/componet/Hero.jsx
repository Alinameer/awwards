...
const Hero = () => {
    ...
    const [isLoading, setIsLoading] = useState(true) //video load first so true
    ...
    const upcomingVideoIndex = (currentIndex % totalVideos) + 1; // we use it so it's only give us the next video and not break the loop
